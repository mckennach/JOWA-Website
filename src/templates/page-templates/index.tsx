...
const components: ComponentMap = {
	...
	'email-signature': dynamic(async () => import('@/src/components/templates/email-signature')),
	default: dynamic(async () => import('@/src/components/templates/page')),
};

export default function PageTemplates({ node }: TemplateProps) {

	const Component = node.slug ? components[node.slug] || components.default : components.default;
