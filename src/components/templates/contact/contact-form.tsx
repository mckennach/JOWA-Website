      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <div className="flex gap-8 w-full">
          <FormField
            ...
            render={({ field }) => (
							<FormItem className="w-full">
								<FormLabel className="sr-only" htmlFor="firstName">First Name*</FormLabel>
								 <FormControl>
								 <Input
										{...field}
          ...
          <FormField
            ...
            render={({ field }) => (
							<FormItem className="w-full">
								<FormLabel className="sr-only" htmlFor="lastName">Last Name*</FormLabel>
								<FormControl>
									<Input
										{...field}
        ...
        <div className="flex gap-8 w-full">
          <FormField
            ...
            render={({ field }) => (
							<FormItem className="w-full">
								<FormLabel className="sr-only" htmlFor="email">E-mail*</FormLabel>
								<FormControl>
									<Input
										{...field}
										placeholder="E-mail*"
          ...
          <FormField
            ...
            render={({ field }) => (
							<FormItem className="w-full">
								<FormLabel className="sr-only" htmlFor="phoneNumber">Phone Number*</FormLabel>
								<FormControl>
									<Input
											{...field}
        ...
        <div className="flex gap-8 w-full">
          <FormField
            ...
            render={({ field }) => (
							<FormItem className="w-full">
								<FormLabel className="sr-only" htmlFor="projectAddress">Project Address*</FormLabel>
								<FormControl>
									<Input
										{...field}
        ...
        <div>
				...
				<FormField 
					...
					render={({ field: { onChange } }) => (
						<FormItem className="w-full">
							...
							<FormControl>
							<div {...getRootProps({ className: 'dropzone' })} className="flex items-center justify-center flex-col border border-foreground bg-background/20 h-[161px]">
								<input {...getInputProps({ onChange })} />

								<p>Drag files here or <span className="underline">select files</span></p>
          ...
          />
				...
				<button type="submit" className="border border-foreground h-[72px] w-full max-w-[307px] !mt-14 text-[24px] leading-[56px] hover:bg-foreground/30">
					Submit
				</button>
      </form>
    </Form>
