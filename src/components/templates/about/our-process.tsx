  ...
  return (
    <Section className="bg-secondary py-10 lg:py-28">
      <Container>
        ...
        <div className="grid gap-x-36 gap-y-20 lg:grid-cols-2">
          <div>
            <div
              dangerouslySetInnerHTML={{ __html: section?.description ?? '' }}
              className={cn(
                'process-description',
                '[&>h3]:uppercase [&>h3]:text-walnut',
                '[&>ul]:list-disc [&>ul]:py-4 [&>ul]:pl-4 [&>ul]:text-cream'
              )}
            />
          </div>
          <div>
            <div className="relative mx-auto aspect-[662/868] max-w-[278px] lg:max-w-[662px]">
              <Image
